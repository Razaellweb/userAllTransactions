import { TokenMetadata } from "../../chains/evm/defi/tokens/ERC20Token";

export const supportedChainsTonativeTokenData: Record<string, TokenMetadata> = {
  eth: {
    name: "Ether",
    symbol: "ETH",
  ...
  polygon: {
    ...
    token_address: "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270", //use wrapped token address for tokenaddress for price fetching
    decimals: 18,
  },
  avalanche: {
    name: "Avalanche",
